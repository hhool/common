...
const char* Common::c_about_dlg::about_str = 
		"����˵��:\r\n"
		"    1.������C����/C++/SDK��ʽ���, ��ɫС��, �����ϵͳ�����κε������ļ�\r\n"
		"    2.��ʵ�ֶԴ���ͨ���Ķ�ȡ��д��,16�������ַ���ʽ����\r\n"
		"    3.֧���ļ�����,���浽�ı�\r\n"
		"    4.֧���Զ�����,�Զ��巢������\r\n"
		"    5.�Զ�ʶ�����д���,��⴮�ڲ������Ƴ�\r\n"
		"    6.֧�ִ��ڳ�ʱ����\r\n"
		...
		"2015-08-02: 1.19 ��Υ��\r\n"
		"    �޸��ˡ����浽�ļ�������\r\n"
		"    ����޷�ʶ�����⴮�ڵ����� && ���ĳЩ��֧�ֵ��¼����� SetCommMask ʧ������\r\n"
		"    �༭�����ӳ��ù��ܣ�����м�ɾ����������\r\n"
		"    ȥ����һЩ����Ҫ�Ĺ��� libtccw32, str2hex, pinctrl\r\n"
        "2015-09-13: 1.20 û��ʲô�޸ģ�ֻ���������ĵ�\r\n"
        "    û��ʲôʵ���Ե��޸ģ��������ĵ���������idxml��tinyxml���߿�\r\n"
		""
		;
		...
		<Vertical inset = "5,5,5,5">
			<Horizontal height="50" inset="0,0,0,0">
				...
				<Vertical inset="0,0,0,5">
					...
					<Static text="Ů������(QQ:191035066) ��ʼ�� 2012-12-24 ƽ��ҹ" height="20"/>
				</Vertical>
			</Horizontal>
			...
			<Horizontal height="30" inset="0,5,0,0">
				<Control />
				<Button name="btn_website" text="�ٷ���ַ" width="100" />
				<Control width="10" />
				<Button name="btn_ok" text="ȷ��" width="100" />
				<Control />
			</Horizontal>
		</Vertical>
	</Vertical>
